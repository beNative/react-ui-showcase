...
const BreadcrumbDemo: React.FC = () => {
    ...
    const SeparatorIcon = () => {
        if (separator === 'slash') return <span className="text-slate-500 mx-2">/</span>;
        return <ChevronRightIcon className="w-4 h-4 text-slate-500 mx-1" />;
    };
            ...
            <LivePreview>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                            ...
                            <ol className="inline-flex items-center">
                                ...
                                <li>
                                    <div className="flex items-center">
                                        <SeparatorIcon />
                                        <a href="#" onClick={e => e.preventDefault()} className="text-sm font-medium text-slate-400 hover:text-sky-400 transition-colors">Projects</a>
                                    </div>
                                </li>
                                 <li>
                                    <div className="flex items-center">
                                        <SeparatorIcon />
                                        <a href="#" onClick={e => e.preventDefault()} className="text-sm font-medium text-slate-400 hover:text-sky-400 transition-colors">UI Library</a>
                                    </div>
                                </li>
                                <li aria-current="page">
                                    <div className="flex items-center">
                                        <SeparatorIcon />
                                        <span className="text-sm font-medium text-slate-200">Components</span>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                    ...
                    <div className="bg-slate-950 border border-slate-800 rounded-lg p-4 space-y-4 w-full">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-slate-300 mb-1">Separator Style</label>
                             <select 
                                value={separator}
                        ...
                        <div>
                             <label className="flex items-center space-x-2 cursor-pointer">
                                ...
                                />
                                <span className="text-sm text-slate-300">Show Home Icon</span>
                            </label>
                        </div>
                    </div>
                </div>
